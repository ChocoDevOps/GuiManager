...
import me.lorenzo.guimanager.opener.ChestInventoryOpener;
import me.lorenzo.guimanager.opener.InventoryOpener;
import me.lorenzo.guimanager.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<UUID, GuiManager> inventories;
    ...
    public List<Player> getOpenedPlayers(GuiManager inv) {
    ...
    public Optional<GuiManager> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    protected void setInventory(Player p, GuiManager inv) {
        if (inv == null)
    ...
    public void handleInventoryOpenError(GuiManager inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while opening GuiManager:", exception);
    }

    public void handleInventoryUpdateError(GuiManager inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while updating GuiManager:", exception);
    }
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                GuiManager inv = inventories.get(p.getUniqueId());
