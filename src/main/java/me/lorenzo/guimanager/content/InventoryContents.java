package me.lorenzo.guimanager.content;

import me.lorenzo.guimanager.ClickableItem;
import me.lorenzo.guimanager.GuiManager;
...
public interface InventoryContents {
    ...
    class Impl implements InventoryContents {
        ...
        public Impl(GuiManager inv, UUID player) {
            this.inv = inv;
            this.player = player;
        ...
        @Override
        public GuiManager inventory() { return inv; }
        ...
        private void update(int row, int column, ItemStack item) {
            ...
            if(!inv.getParentManager().getOpenedPlayers(inv).contains(currentPlayer))
                return;
