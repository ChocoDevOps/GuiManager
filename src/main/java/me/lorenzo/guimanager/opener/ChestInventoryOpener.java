package me.lorenzo.guimanager.opener;

import com.google.common.base.Preconditions;
import me.lorenzo.guimanager.GuiManager;
import me.lorenzo.guimanager.InventoryManager;
...
public class ChestInventoryOpener implements InventoryOpener {
    ...
    @Override
    public Inventory open(GuiManager inv, Player player) {
        ...
        InventoryManager manager = inv.getParentManager();
